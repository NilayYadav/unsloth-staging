...
HEAD = "291d5b8a777f6157395c209340cae66fd53f3f57"
...
lines = ["# PR 11299 export upload A/B", "", f"Base `{BASE}`; head `{HEAD}`.", "", "Identical tests and fixtures; only `export.py` changes.", "", "Before: 4 intended regression failures / 46 tests. After: 46 passed.", "", "| Scenario | Before bytes | After bytes | Before unwanted files |", "|---|---:|---:|---|"]
